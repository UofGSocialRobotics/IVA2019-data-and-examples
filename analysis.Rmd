...
generate_anovas <- function(data) {
  ...
  print(summary(aov(normalized_scores ~ condition, data=filter(data, metaphor_measure=='closeness'))))
  print(summary(aov(normalized_scores ~ condition, data=filter(data, metaphor_measure=='conflict'))))
  print(summary(aov(normalized_scores ~ condition, data=filter(data, metaphor_measure=='control'))))
  print(summary(aov(normalized_scores ~ condition, data=filter(data, metaphor_measure=='open'))))
  print(summary(aov(normalized_scores ~ condition, data=filter(data, metaphor_measure=='size'))))
}
```
